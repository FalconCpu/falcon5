...
class InstrLoadField(val size:Int, val dest: Reg, val addr: Reg, val offset: FieldSymbol, val offset2:Int) : Instr()
class InstrStoreField(val size:Int, val src: Reg, val addr: Reg, val offset:FieldSymbol, val offset2:Int) : Instr()
