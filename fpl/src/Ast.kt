...
class AstLongLiteral(location: Location, val value: Long) : AstExpr(location)
...
class AstStructDefStmt(location: Location, val name: String, val fields: List<AstParameter>) : AstBlock(location,emptyList())
